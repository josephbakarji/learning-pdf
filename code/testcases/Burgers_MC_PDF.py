...
A = Analyze()
savename = 'Burgers_MC_PDF'
A.plotRMSEandCoefs(output_vec, MCcountvec, 'Number of Realizations', threshold=0.01, set_grid=True, cdf=False, invert_sign=True, savename='Burgers_MC_CDF')
